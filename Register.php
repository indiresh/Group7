...
<h1 class="center" style="width:20%;color:firebrick;position:relative;top:60px;left:2px">Welcome to the Registration Page!</h1>
<h1 class="center" style="width:20%;">Welcome to the Registration Page!</h1>
...
?>
<p class="center" style="background-color:firebrick;width:20%">Thank you, <?php echo $_POST['user']; ?> for registering!<br /><a href="http://secs.oakland.edu/~mrkokko/CSE252-Slots/slotLogic.php" style="color:white">Click Here</a> to continue to the Slot Machine.</p>
<?php
}
} 
else
...
<h1 class="center" style="width:20%;color:firebrick;position:relative;top:95px;left:2px">Welcome to the Registration Page!</h1>
<h1 class="center" style="width:20%;">Welcome to the Registration Page!</h1>
<form name="register" action="Register.php" onsubmit="return validateForm()" method="post">
<table class="center"  style="width:25%;background-color:firebrick">
<tr><td align="right">Username: </td><td align="left"><input type="text" name="user"></td></tr>
